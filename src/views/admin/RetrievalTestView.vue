...
import type { RetrieveResult, Course } from '@/types'
...
async function handleSearch() {
  ...
  try {
    ...
    const res = await apiFetch<RetrieveResult[]>('/admin/retrieval-test', {
      method: 'POST',
      body: {
  ...
  <div class="p-6">
    ...
    <div class="rounded-lg p-5 mb-6" style="background: var(--lt-bg-card); box-shadow: var(--lt-shadow-card);">
      ...
      <div class="flex flex-wrap items-center gap-3">
        <el-select v-model="courseId" placeholder="全部课程" size="small" style="width: 160px" clearable>
